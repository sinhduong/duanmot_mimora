    ...
    <form action="" method="post" enctype="multipart/form-data">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" required id="exampleInputEmail1" name="email" value="<?=$email?>" placeholder="Email">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Địa chỉ</label>
                <input type="text" class="form-control" required id="exampleInputEmail1" name="dia_chi" value="<?=$dia_chi?>" placeholder="Địa chỉ">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" required id="exampleInputEmail1" name="phone"  value="<?=$phone?>" placeholder="Số điện thoại">
            </div>
            <div class="form-group">
