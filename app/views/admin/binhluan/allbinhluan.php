    ...
    <tbody>
       ...
       foreach($binhluan as $row):
        ...
        <tr>
            ...
            <td ><span  style="color:red; font-size:25px;"> <?=$danh_gia?></span>  SAO</td>
            <td>
                <!-- <a href="index.php?act=editbinhluan&id=id&table=binh_luan&id_edit=<?=$id?>"><button class="btn btn-warning">Sửa</button></a> -->
