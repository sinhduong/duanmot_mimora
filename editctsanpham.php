...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">Sửa chi tiết sản phẩm</h3>
    </div>
    <!-- /.card-header -->
    <!-- form start -->
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
                ...
                <input type="text" class="form-control" required name="name" value="<?=$name?>" id="exampleInputPassword1" placeholder="Tên sản phẩm">
            </div>
            <div class="form-group">
                <label for="exampleInputPassword1">giá gốc</label>
                <input type="text" class="form-control" required name="gia" value="<?=$gia?>" id="exampleInputPassword1" placeholder="Giá gốc">
            </div>
            <div class="form-group">
                <label for="exampleInputPassword1">giá giảm</label>
                <input type="text" class="form-control" required name="gia_giam" value="<?=$gia_giam?>" id="exampleInputPassword1" placeholder="Giá giảm">
            </div>
            <div class="form-group">
                <label for="exampleInputPassword1">mô tả</label>
                <input type="text" class="form-control" required name="mo_ta" value="<?=$mo_ta?>" id="exampleInputPassword1" placeholder="Mô tả">
            </div>
            <div class="form-group">
